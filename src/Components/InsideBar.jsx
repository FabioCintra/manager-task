...
export default function InsideBar({projects, changeScreen}){
    ...
    return(
        <aside className="flex-none h-screen bg-amber-950 w-64 px-5 py-5 space-y-5 rounded-r-2xl">
            ...
            <button className="px-3.5 py-1.5 bg-olive-500 text-xs text-olive-300 rounded hover:bg-olive-400" onClick={() => changeScreen('createProject')}>
                + Add Project
            </button>
            <ol >
